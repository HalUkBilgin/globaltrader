...
public class US_03_CompanySellerJoinStepDefinitions {
    ...
    public void kullanici_Email_girer() {
        ...
        String newEmail = ReusableMethods.getNewEmail(email);
        System.out.println("Yeni mail :" + newEmail );
        companySellerJoinPage.email.sendKeys(newEmail);
    }
    ...
    public void kullanici_Mobile_Number_girer() {
        String mobileNumber = ConfigurationReader.getProperty("vender_mobile");
        String newMobileNumber = ReusableMethods.getNewMobileNumber(mobileNumber);
        companySellerJoinPage.venderMobile.sendKeys(newMobileNumber);
    }
